...
/**
 * copy from {@link com.wenchao.cardstack.CardStack}
 * what changed: check lines with EDIT tag.
 */
public class CardStackPort extends RelativeLayout {
    ...
    private CardEventListener mEventListener = new DefaultStackEventListenerPort(300);
    ...
    public interface CardEventListener{
        ...
        // EDIT add cardView
        boolean swipeEnd(View cardView, int section,float distance);
        boolean swipeStart(int section,float distance);
        // EDIT add cardView
        // EDIT add cardView
        boolean swipeContinue(View cardView, int section, float distanceX, float distanceY);
    ...
    public CardStackPort(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setThreshold(int t){
        mEventListener = new DefaultStackEventListenerPort(t);
    }
    ...
    private void setupAnimation(){
        ...
        final DragGestureDetector dd = new DragGestureDetector(CardStackPort.this.getContext(),new DragGestureDetector.DragListener(){
            ...
            public boolean onDragContinue(MotionEvent e1, MotionEvent e2,
                ...
                mCardAnimator.drag(e1,e2,distanceX,distanceY);
                mEventListener.swipeContinue(viewCollection.get(viewCollection.size()-1), direction, Math.abs(x2-x1),Math.abs(y2-y1));
                return true;
            }
            ...
            public  boolean onDragEnd(MotionEvent e1, MotionEvent e2) {
                ...
                boolean discard = mEventListener.swipeEnd(viewCollection.get(viewCollection.size()-1), direction, distance);
                if(discard){
                    mCardAnimator.discard(direction, new AnimatorListenerAdapter(){
    ...
    public CardStackPort(Context context) {
        super(context);
    }
